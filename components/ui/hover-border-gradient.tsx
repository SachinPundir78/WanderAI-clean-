...
interface HoverBorderGradientProps
  ...
  className?: string;
  as?: keyof React.JSX.IntrinsicElements; // "button" | "div" | "a" etc.
  duration?: number;
  clockwise?: boolean;
}
...
export function HoverBorderGradient({
  ...
  const rotateDirection = (currentDirection: Directions): Directions => {
    const directions: Directions[] = ["TOP", "LEFT", "BOTTOM", "RIGHT"];
  ...
  const movingMap: Record<Directions, string> = {
  ...
  return (
    <Tag
      ...
      {...props} // ✅ Now accepts type, disabled, onClick, etc.
    >
      <div
        className={cn(
